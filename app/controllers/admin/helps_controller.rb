class Admin::HelpsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @help.save
        format.html { redirect_to admin_help_url(@help), notice: 'Help was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @help.update_attributes(params[:help])
        format.html { redirect_to admin_help_url(@help), notice: 'Help was successfully updated.' }
